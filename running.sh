...
status_udp=$(systemctl status udp | grep Active | awk '{print $3}' | cut -d "(" -f2 | cut -d ")" -f1)
...
echo -e "\E[44;1;39m            ⇱ -CANDRA- VPN Store ⇲           \E[0m"
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
