...
export sem=$( curl -s https://raw.githubusercontent.com/gazzent/xraylite/main/versions)
...
echo -e "  ${BLUE}• ${GREEN}Developer           ${NC}= kingstore Tunneling ${NC}"
echo -e "$COLOR1┌────────────────────────────────────────────────────────────┐${NC}"
...
echo -e " ${BICyan}[${BIWhite}24${BICyan}]${RED} •${NC} ${YELLOW}REGISTRASI MENU           $NC"
echo -e " ${BICyan}[${BIWhite}25${BICyan}]${RED} •${NC} ${YELLOW}INSTALL BOT NOTIF LIMIT          $NC"
echo -e " ${BICyan}[${BIWhite} 99 ${BICyan}] UPDATE SC ${BICyan}${BIYellow}${BICyan}${NC}"
echo -e "$COLOR1━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"

echo -e "${BICyan}┌──────────────────────────────────────────────────┐${NC}"
echo -e "${BICyan}│ ${BOLD}${GREEN}ID Client = $Name                           ${NC}"
echo -e "${BICyan}│ ${BOLD}${RED}Expired   = $Exp                            ${NC}"
echo -e "${BICyan}│ ${BOLD}${YELLOW}Developer = CANDRA VPNZ STORE                  ${NC}"
...
99) clear ; update ;;
22) clear ; fix ;;
23) clear ; clear ; wget https://raw.githubusercontent.com/NevermoreSSH/Vergil/main/Tunnel/udp.sh && bash udp.sh ;;
24) clear ; admin ;;
25) clear ; xolpanel ;;
