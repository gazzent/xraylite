...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e " $COLOR1┌───────────────────────────────────────────────┐${NC}"
echo -e " $COLOR1│$NC   ${COLOR1}[01]${NC} • ADD TROJAN$COLOR1│$NC"
echo -e " $COLOR1│$NC   ${COLOR1}[02]${NC} • RENEW TROJAN$COLOR1│$NC"
echo -e " $COLOR1│$NC   ${COLOR1}[03]${NC} • DELETE TROJAN  $COLOR1│$NC"
echo -e " $COLOR1│$NC   ${COLOR1}[04]${NC} • USER ONLINE    $COLOR1│$NC"
echo -e " $COLOR1│$NC   ${COLOR1}[05]${NC} • TRIAL TROJAN${NC}   $COLOR1│$NC"
echo -e " $COLOR1│$NC   ${COLOR1}[06]${NC} • CONFIG TROJAN${NC}   $COLOR1│$NC"
