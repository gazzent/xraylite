...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e " $COLOR1┌───────────────────────────────────────────────┐${NC}"
echo -e " $COLOR1│$NC   ${COLOR1}[01]${NC} • ADD VMESS $COLOR1│$NC"
echo -e " $COLOR1│$NC   ${COLOR1}[02]${NC} • RENEW VMESS $COLOR1│$NC"
echo -e " $COLOR1│$NC   ${COLOR1}[03]${NC} • DELETE VMESS$   $COLOR1│$NC"
echo -e " $COLOR1│$NC   ${COLOR1}[04]${NC} • USER ONLINE    $COLOR1│$NC"
echo -e " $COLOR1│$NC   ${COLOR1}[05]${NC} • TRIAL VMESS${NC}   $COLOR1│$NC"
echo -e " $COLOR1│$NC   ${COLOR1}[06]${NC} • CONFIG VMESS${NC}   $COLOR1│$NC"
